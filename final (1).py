...
# ===========================================================
# 🖼️ TAB 1: IMAGE ANALYSIS
# ===========================================================
with tab1:
    st.header("🖼️ Image Analysis with DeepFace")
...
with tab2:
    ...
    # -------------------------------------------------------
    # 🎙️ SPEECH TO TEXT (Corrected & Error-Free)
    # -------------------------------------------------------
            ...
            if st.button("📝 Transcribe Audio"):
                with st.spinner("Transcribing... please wait..."):
                    ...
                    try:
                        ...
                        st.error("⚠️ Google Speech API unavailable or network issue.")
        except Exception as e:
